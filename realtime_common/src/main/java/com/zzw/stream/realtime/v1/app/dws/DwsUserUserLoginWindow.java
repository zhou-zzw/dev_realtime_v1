...
import com.zzw.stream.realtime.v1.bean.UserLoginBean;
...
/**
 * @Package com.zzw.stream.realtime.v1.app.dws.DwsUserUserLoginWindow
...
public class DwsUserUserLoginWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_traffic_page_zhengwei_zhou", "dws_user_user_login_window");
