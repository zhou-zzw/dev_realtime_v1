package com.zzw.stream.realtime.v1.app.dws;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.zzw.stream.realtime.v1.bean.TrafficVcChArIsNewPageViewBean;
import com.zzw.stream.realtime.v1.function.BeanToJsonStrMapFunction;
import com.zzw.stream.realtime.v1.utils.DateFormatUtil;
...
/**
 * @Package com.zzw.stream.realtime.v1.app.dws.DwsTrafficVcChArIsNewPageViewWindow
...
public class DwsTrafficVcChArIsNewPageViewWindow {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("dwd_traffic_page_zhengwei_zhou", "dws_traffic_vc_ch_ar_is_new_page_view_window");
