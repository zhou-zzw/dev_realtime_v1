...
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    private final List<com.label.hg.DimBaseCategory> dimBaseCategories;
    ...
    public MapOrderAndDetailRateModelFunc(List<com.label.hg.DimBaseCategory> dimBaseCategories, double timeRate, double amountRate, double brandRate, double categoryRate) {
